...
public class OSCoreCtx {
     ...
     * This is generally optional and can be controlled by the application.
     *
     ...
     *
     * This variable will control the behaviour when sending Response messages with this context.
     * Note that Observe notifications will always include a new partial IV.
     *
     * Default value is false.
     */
     ...
     *
     * That is what URI it is associated and stored under in
     * the HashMapCtxDB.
     */
    private String uri;
    ...
    /**
     * Get the flag controlling whether or not to generate a new
     * partial IV for outgoing Response messages using this context.
     * 
    ...
    /**
     * Set the flag controlling whether or not to generate a new
     * partial IV for outgoing Response messages using this context.
     * 
    ...
    /**
     * Get a string representation of the context ID.
     * (A string showing the hexadecimal bytes.)
     *
    ...
    /**
     * Get a string representation of the sender ID.
     * (A string showing the hexadecimal bytes.)
     *
    ...
    /**
     * Get a string representation of the recipient ID.
     * (A string showing the hexadecimal bytes.)
     *
