...
```sh
java -jar cf-proxy2-3.6.0.jar ExampleCrossProxy2 coap http
```
...
```sh
java -jar cf-proxy2-3.6.0.jar ExampleProxy2CoapClient
```

Start a example http-client (same host as proxy):

```sh
java -jar cf-proxy2-3.6.0.jar ExampleProxy2HttpClient
```
...
```sh
java -jar cf-proxy2-3.6.0.jar ExampleSecureProxy2 coaps
```
...
```sh
java -jar cf-proxy2-3.6.0.jar ExampleSecureProxy2CoapClient
```
