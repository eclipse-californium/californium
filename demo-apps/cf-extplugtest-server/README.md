...
```sh
java -jar target/cf-extplugtest-server-3.0.0-RC1.jar --dtls-cluster ":15784;localhost:15884;1,---;localhost:25884;2"
```
...
```sh
java -jar target/cf-extplugtest-server-3.0.0-RC1.jar --dtls-cluster "---;localhost:15884;1,:25784;localhost:25884;2"
```
