 ...
 *                                                 move initializeSsl and
 *                                                 createMessage to new 
 *                                                 ConnectorTestUtil
 ******************************************************************************/
...
public class TlsConnectorTest {
	...
	public void pingPongMessage() throws Exception {
		...
		// opened
		msg = ConnectorTestUtil.createMessage(serverCatcher.getMessage(0).getInetSocketAddress(), 10000, null);
		server.send(msg);
	...
	public void singleClientManyServers() throws Exception {
		...
		for (InetSocketAddress address : servers.keySet()) {
			RawData message = ConnectorTestUtil.createMessage(address, 100, null);
