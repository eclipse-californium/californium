...
public final class DtlsConfig {
	 ...
	 * enabled, connections without authenticated clients are removed after a
	 * short timeout (120s). To protect such connections from being removed, the
	 * application is required to use the {@link ApplicationAuthorizer} to
	 * authorize such connections.
	 * 
