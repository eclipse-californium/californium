 ...
 */
public class SyncAdvancedPskStore extends AbstractSyncPskStore {
	 ...
	 */
	public SyncAdvancedPskStore(PskStore pskStore) {
		if (pskStore == null) {
	...
	@Override
	protected SecretKey getPSKSecret(ServerNames serverNames, PskPublicInformation identity) {
		return serverNames != null ? pskStore.getKey(serverNames, identity) : pskStore.getKey(identity);
	}
