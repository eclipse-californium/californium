 ...
 *                                                    identity. issue #649
 *    Achim Kraus (Bosch.IO GmbH)                   - copied from version 2.6 for
 ...
 */
public final class BackwardsCompatiblePrincipalSerializer {

	private static final int PSK_HOSTNAME_LENGTH_BITS = 16;
	private static final int PSK_IDENTITY_LENGTH_BITS = 16;

	private BackwardsCompatiblePrincipalSerializer() {
	}

	/**
	 * Deserializes a principal to a byte array based on the plain text encoding defined in
